                ...
                children=[
                    html.Div([
                        ...
                        html.P([
                            ...
                            The dashboard is the output of a doctoral research project, which sought to answer the following overarching research question (RQ):''', html.Br(),html.Br(),''' 
                            - Can applying ethical distributional principles within a dashboard shed light on nation-state effort-sharing for climate change?''', html.Br(),html.Br(),'''
                            Pages 2-4 focus on answering the following three sub RQs:''', html.Br(),html.Br(),'''        
                            - RQ1: What are countries\' historical contributions to global warming?''', html.Br(),html.Br(),'''   
                            - RQ2: How should the costs of climate change be distributed between countries?''', html.Br(),html.Br(),'''   
                            - RQ3: How should rights to emit and warming rights be distributed between countries?''', html.Br(),html.Br(), html.Br(),html.Br(),'''      
